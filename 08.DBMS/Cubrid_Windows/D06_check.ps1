...
$finalResult = "N/A"
$status = "N/A"
$summary = "Cubrid_Windows is not a target platform for D-06 according to docs/guideline_metadata.json."
$commandOutput = "D-06 target: Oracle DB, MSSQL, MySQL, Altibase, Tibero, PostgreSQL 등"
$commandExecuted = "guideline_metadata.json D-06 target platform review"
