...
$finalResult = "N/A"
$status = "N/A"
$summary = "WebtoB_Windows is not a target platform for WEB-13 according to docs/guideline_metadata.json."
$commandOutput = "WEB-13 target: Tomcat, IIS, JEUS"
$commandExecuted = "guideline_metadata.json WEB-13 target platform review"
