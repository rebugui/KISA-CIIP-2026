...
try {
    ...
    $summary = "Nginx for Windows is not a target platform for WEB-01 according to docs/guideline_metadata.json."
    $commandOutput = "WEB-01 targets Tomcat and JEUS default administrator console accounts. Nginx does not provide a built-in default web administrator account for this guideline item."
